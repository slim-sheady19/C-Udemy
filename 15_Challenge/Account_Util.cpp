...
//Helpers for Chequing

// Displays Chequing Account objects in a  vector of Savings Account objects 
...
// Deposits supplied amount to each Chequing_Account object in the vector
void deposit(std::vector<Chequing_Account> &accounts, double amount) {
    std::cout << "\n=== Depositing to Chequing_Account ==========================" << std::endl;
    for (auto &acc:accounts)  {
        if (acc.deposit(amount)) 
            std::cout << "Deposited " << amount << " to " << acc << std::endl;
        else
...
// Withdraw supplied amount from eachChequing_Accountobject in the vector
void withdraw(std::vector<Chequing_Account> &accounts, double amount) {
    std::cout << "\n=== Withdrawing from Chequing Accounts ======================" << std::endl;
    for (auto &acc:accounts)  {
        if (acc.withdraw(amount)) 
            std::cout << "Withdrew " << amount << " from " << acc << std::endl;
        else
